 ...
 * @author HP
 */
public class ViewSchools extends javax.swing.JFrame {

    /**
     * Creates new form ViewSchools
     */
    public ViewSchools() {
        initComponents();
        loadRecords();
    ...
    private void initComponents() {
        ...
        Title.setText("VIEW SCHOOLS HERE");
    ...
    private void loadRecords() {
        ...
        try {
            File myObj = new File("Schools.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSchools.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
