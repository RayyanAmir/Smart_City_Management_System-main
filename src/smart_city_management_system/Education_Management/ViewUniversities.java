 ...
 * @author HP
 */
public class ViewUniversities extends javax.swing.JFrame {

    /**
     * Creates new form ViewUniversities
     */
    public ViewUniversities() {
        initComponents();
        loadRecords();
    }
    ...
    private void initComponents() {
        ...
        Title.setText("VIEW UNIVERSITIES HERE");
    ...
    private void loadRecords() {
        ...
        try {
            File myObj = new File("Universities.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUniversities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
